...
| **Was noch offen ist** | **`docs/plans/BEWEIS-PLAN.md`** — der Gerätetag (W2.8) und die Tests für die SDK-Schicht (W2.1), in Runden nach Rüstzeug. **Die Schreibtisch-Runde A1 läuft seit dem 17.09.2026**; dort stehen auch die Befunde daraus und die Einordnung aller S-Zeilen. Gezählt: **195 offen von 303** |
