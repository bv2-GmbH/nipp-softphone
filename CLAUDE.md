...
| Warum etwas davon abweicht | **`docs/decisions.md`** — ADR-001 bis ADR-072, dazu **ADR-072 als Entwurf**: die sechs offenen Befunde der Runde A1 mit ihren Optionen, **nicht entschieden** |
...
| Warum weicht etwas davon ab? | **`docs/decisions.md`** — ADR-001 bis ADR-072 |
