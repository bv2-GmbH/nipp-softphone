...
| **Was noch offen ist** | **`docs/plans/BEWEIS-PLAN.md`** — der Gerätetag (W2.8) und die Tests für die SDK-Schicht (W2.1), in Runden nach Rüstzeug. **Die Schreibtisch-Runde A1 läuft seit dem 17.09.2026** und hat in sieben Messrunden 43 Zeilen abgenommen; die zwölf Befunde der ersten fünf (A1-1 bis A1-12) sind **alle erledigt** (21.09.2026), die beiden der sechsten (A1-13, A1-14) ebenfalls — **repariert und nachgemessen am 22.09.2026**; aus der siebten ist **A1-16 behoben** (zehn Listenvorlagen ohne Namen, `ListenNamenTests` hält es fest), während **A1-15 ein falscher Alarm war** (der falsche Knopf, eine Stunde nach dem Push aufgeklärt). Dort steht auch die Einordnung aller S-Zeilen. Gezählt: **186 offen von 308**, davon 59 am Schreibtisch — **und die Zahl ist ab jetzt nachrechenbar**: `Zaehle-Matrix.ps1` in den Testaufbauten trägt die Zählregel, denn die bisher fortgeschriebenen 190 von 303 liessen sich aus der Matrix nicht herstellen. **Repariert wird gesammelt, nicht mitten in einer Messrunde** — sonst prüft die halbe Runde gegen einen anderen Build als die andere; deshalb kamen die Reparaturen erst, als die Messrunden durch waren |
