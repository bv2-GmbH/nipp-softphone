...
| **Was noch offen ist** | **`docs/plans/BEWEIS-PLAN.md`** — der Gerätetag (W2.8) und die Tests für die SDK-Schicht (W2.1), in Runden nach Rüstzeug. **Die Schreibtisch-Runde A1 läuft seit dem 17.09.2026** und hat in fünf Messrunden 32 Zeilen abgenommen; die zwölf Befunde daraus (A1-1 bis A1-12) sind **alle erledigt** (Stand 21.09.2026) — zehn repariert und nachgemessen, A1-3 durch die Streichung in §10 (ADR-055, Nachtrag), A1-4 als **falscher Alarm aufgeklärt**. Dort steht auch die Einordnung aller S-Zeilen. Gezählt: **190 offen von 303**, davon 69 am Schreibtisch. **Repariert wird gesammelt, nicht mitten in einer Messrunde** — sonst prüft die halbe Runde gegen einen anderen Build als die andere; deshalb kamen die Reparaturen erst, als die Messrunden durch waren |
